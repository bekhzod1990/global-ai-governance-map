// Static ISO-3166 numeric ↔ alpha-3 lookup. Replaces i18n-iso-countries
// (which ships ~250 kB of locale data we don't use) with a hand-rolled
// table covering every entity in world-atlas countries-110m.json plus a
// few entities the topojson uses that aren't strict UN members.
